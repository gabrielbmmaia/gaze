...
import 'package:gaze/features/series/domain/usecases/get_series_by_gender.dart';
...
void main() {
  ...
  late GetSeriesByGenderUseCase useCase;

  setUp(() {
    repo = MockSeriesRepo();
    useCase = GetSeriesByGenderUseCase(repo);
  });
