...
class GetNetflixSeriesUseCase extends UseCaseWithoutParams<List<SeriesModel>> {
  const GetNetflixSeriesUseCase(this._repo);

  final SeriesRepo _repo;

  @override
  ResultFuture<List<SeriesModel>> call() => _repo.getNetflixSeries();
}
