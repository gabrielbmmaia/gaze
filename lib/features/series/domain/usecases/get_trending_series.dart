...
class GetTrendingSeriesUseCase extends UseCaseWithoutParams<List<SeriesModel>> {
  const GetTrendingSeriesUseCase(this._repo);

  final SeriesRepo _repo;

  @override
  ResultFuture<List<SeriesModel>> call() => _repo.getTrendingSeries();
}
